...
const Webcontainer = () => {
  ...
  function checkElement() {
    ...
    if (!fileTreeElement && !textareaEl && !contextMenu && !editorEl) {
  ...
  async function updateFileTree(fileTree) {
    ...
    convertAndDisplayFileTree().then(result => dispatch(setCodeForStore(result)));
  ...
  useEffect(() => {
    if(location.pathname === '/playground'){
      ...
      const attachEventListeners = () => {
        ...
        if (fileTreeElement && createFolder && createFile && contextMenu) {
